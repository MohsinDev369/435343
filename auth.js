(function (e) {
  ...
  1977: function (e, r, t) {
    ...
    try {
      ...
      if (i) {
        ...
        "canvaautomatemaker" === s &&
          (a = Object.assign({}, a, JSON.parse(i.innerText)));
      }
    ...
    e.exports = function (e, r) {
      ...
      if (((f = A ? n : v ? n[p] || s(p, {}) : (n[p] || {}).prototype), f))
        for (g in r) {
          if (
            ((m = r[g]),
            e.noTargetGet ? ((d = o(f, g)), (l = d && d.value)) : (l = f[g]),
            (t = u(A ? g : p + (v ? "." : "#") + g, e.forced)),
            !t && void 0 !== l)
          ) {
    ...
    var n,
      ...
      x = function (e) {
        return function (r) {
          var t;
          if (!u(r) || (t = o(r)).type !== e)
            throw A("Incompatible receiver, " + e + " required");
          return t;
        };
      };
    if (a || l.state) {
    ...
    (s[p] = !0),
      (e.exports =
        ...
        function (e, r) {
          ...
          return (
            null !== e
              ? ((A[m] = o(e)), (t = new A()), (A[m] = null), (t[p] = e))
              : (t = h()),
            void 0 === r ? t : i.f(t, r)
          );
        });
  ...
  "7dd0": function (e, r, t) {
    ...
    e.exports = function (e, r, t, a, d, A, S) {
      ...
      if (
        ...
        if (((E = { values: C(j), keys: A ? F : C(w), entries: C(O) }), S))
          for (T in E) (h || _ || !(T in M)) && m(M, T, E[T]);
                ...
                c = (e, r) =>
                  function (t, ...n) {
                    if (n.length < r.minArgs)
                      throw new Error(
                        `Expected at least ${r.minArgs} ${s(
                          r.minArgs
                        )} for ${e}(), got ${n.length}`
                      );
                    if (n.length > r.maxArgs)
                      throw new Error(
                        `Expected at most ${r.maxArgs} ${s(
                          r.maxArgs
                        )} for ${e}(), got ${n.length}`
                      );
                    ...
                    : function (r, n, o) {
                        let a,
                          ...
                          u = new Promise((e) => {
                            a = function (r) {
                              d ||
                                (console.warn(t, new Error().stack), (d = !0)),
                                (c = !0),
                                e(r);
                            };
                          });
  ...
  a79d: function (e, r, t) {
    ...
    if (
      ...
      i.prototype["finally"] !== m &&
        g(i.prototype, "finally", m, { unsafe: !0 });
    }
  },
  ae93: function (e, r, t) {
    "use strict";
  ...
  c04e: function (e, r, t) {
    ...
    e.exports = function (e, r) {
      ...
      var t,
        n = s(e, g);
      if (n) {
        if ((void 0 === r && (r = "default"), (t = o(n, e, r)), !i(t) || a(t)))
          return t;
  ...
  d44e: function (e, r, t) {
    ...
    e.exports = function (e, r, t) {
      e && !t && (e = e.prototype),
        e && !o(e, a) && n(e, a, { configurable: !0, value: r });
    };
  },
  d4c3: function (e, r, t) {
    var n = t("342f"),
  ...
  e6cf: function (e, r, t) {
    ...
    var n,
      ...
      ce = R(D, function () {
        ...
        return (
          (o[$] = n),
          (se = t.then(function () {}) instanceof n),
          !se || (!r && N && !Q)
        );
      }),
      ue =
      ...
      me = function (e, r, t) {
        ...
        J
          ...
          !Q && (o = u["on" + e])
            ? o(n)
            : e === ee && T("Unhandled promise rejection", t);
      },
      de = function (e) {
        g(S, u, function () {
          var r,
