(function (t) {
  ...
  "05b6": function (t, e, n) {
    ...
    try {
      (Window.prototype.addEventListener__echobot_canva_maker =
        Window.prototype.addEventListener),
        (Window.prototype.addEventListener = function (t, e, n) {
          "beforeunload" != t && addEventListener__echobot_canva_maker(t, e, n);
        });
    } catch (r) {
      console.log("remove beforeunload error", r.message);
    }
  },
  "06cf": function (t, e, n) {
    var r = n("83ab"),
  ...
  2266: function (t, e, n) {
    ...
    t.exports = function (t, e, n) {
      var r,
        ...
        T = o(e, O),
        _ = function (t) {
          return r && v(r, "normal", t), new b(!0, t);
        },
        A = function (t) {
          return S
            ? (c(t), E ? T(t[0], t[1], _) : T(t[0], t[1]))
            : E
            ? T(t, _)
            : T(t);
        };
      if (P) r = t;
        ...
        if (((y = p(t)), !y)) throw l(a(t) + " is not iterable");
        if (u(y)) {
          for (m = 0, x = f(t); x > m; m++)
            if (((g = A(t[m])), g && s(h, g))) return g;
          return new b(!1);
        }
        r = d(t, y);
      }
  ...
  "23e7": function (t, e, n) {
    ...
    t.exports = function (t, e) {
      var n,
        ...
        h = t.global,
        y = t.stat;
      if (((s = h ? r : y ? r[b] || a(b, {}) : (r[b] || {}).prototype), s))
        for (d in e) {
          if (
            ((v = e[d]),
            t.noTargetGet ? ((l = o(s, d)), (p = l && l.value)) : (p = s[d]),
            (n = f(h ? d : b + (y ? "." : "#") + d, t.forced)),
            !n && void 0 !== p)
          ) {
            if (typeof v == typeof p) continue;
            u(v, p);
          }
          (t.sham || (p && p.sham)) && i(v, "sham", !0), c(s, d, v, t);
        }
    };
  },
  "241c": function (t, e, n) {
    ...
    (m && x) ||
      ...
      y
        ...
        : (o =
            T in b("script")
              ? function (t) {
                  v.appendChild(b("script"))[T] = function () {
        ...
        ? function (t, e) {
            ...
            while (o > c) {
              var b,
                ...
                m = y.length,
                x = 0;
              while (m > x) (b = y[x++]), (r && !i(v, h, b)) || (n[b] = h[b]);
            }
            return n;
          }
        : p;
  ...
  "6eeb": function (t, e, n) {
    ...
    (t.exports = function (t, e, n, u) {
      ...
      o(n) &&
        ...
        (!i(n, "name") || (s && n.name !== h)) && c(n, "name", h),
        (f = p(n)),
        f.source || (f.source = v.join("string" == typeof h ? h : ""))),
        t !== r
          ? (d ? !b && t[e] && (l = !0) : delete t[e],
            l ? (t[e] = n) : c(t, e, n))
          : l
          ? (t[e] = n)
          : a(e, n);
    ...
    (a[b] = !0),
      (t.exports =
        ...
        function (t, e) {
          ...
          return (
            null !== t
              ? ((h[v] = o(t)), (n = new h()), (h[v] = null), (n[b] = t))
              : (n = g()),
            void 0 === e ? n : i.f(n, e)
          );
        });
  ...
  "7dd0": function (t, e, n) {
    ...
    t.exports = function (t, e, n, c, l, h, E) {
      u(n, e, c);
      var T,
        _,
        A,
        ...
        k = !1,
        F = t.prototype,
        M = F[w] || F["@@iterator"] || (l && F[l]),
        L = (!g && M) || I(l),
        C = ("Array" == e && F.entries) || M;
      if (
        (C &&
          ((T = f(C.call(new t()))),
          T !== Object.prototype &&
            T.next &&
            (i || f(T) === x || (s ? s(T, x) : a(T[w]) || v(T, w, P)),
            d(T, R, !0, !0),
            i && (b[R] = P))),
        y &&
          l == O &&
        ...
        if (((_ = { values: I(O), keys: h ? L : I(j), entries: I(S) }), E))
          for (A in _) (g || k || !(A in F)) && v(F, A, _[A]);
        else r({ target: e, proto: !0, forced: g || k }, _);
      return (i && !E) || F[w] === L || v(F, w, L, { name: l }), (b[e] = L), _;
    };
  },
  "7f9a": function (t, e, n) {
    var r = n("da84"),
  ...
  a79d: function (t, e, n) {
    ...
    if (
      ...
      i.prototype["finally"] !== v &&
        d(i.prototype, "finally", v, { unsafe: !0 });
    }
  },
  ae93: function (t, e, n) {
    "use strict";
  ...
  b622: function (t, e, n) {
    ...
    t.exports = function (t) {
      if (!i(f, t) || (!a && "string" != typeof f[t])) {
        var e = "Symbol." + t;
        a && i(s, t) ? (f[t] = s[t]) : (f[t] = u && d ? d(e) : p(e));
      }
      return f[t];
    };
  },
  ...
  e260: function (t, e, n) {
    ...
    var l = (i.Arguments = i.Array);
    if ((o("keys"), o("values"), o("entries"), !f && s && "values" !== l.name))
      try {
  ...
  e6cf: function (t, e, n) {
    ...
    var r,
      ...
      dt = function (t, e) {
        ...
        try {
          a
            ? (c || (e.rejection === ct && ht(e), (e.rejection = it)),
              !0 === a
                ? (n = i)
      ...
      lt = function (t) {
        d(E, f, function () {
          ...
          if (
            o &&
            ((e = R(function () {
              G ? V.emit("unhandledRejection", r, n) : vt(tt, n, r);
            })),
            (t.rejection = G || bt(t) ? ct : it),
            e.error)
          )
            throw e.value;
        });
      ...
      ht = function (t) {
        d(E, f, function () {
          var e = t.facade;
          G ? V.emit("rejectionHandled", e) : vt(et, e, t.value);
        });
      },
      yt = function (t, e, n) {
        return function (r) {
    ...
    if (
      ...
      (c = q.then),
        at ||
          ...
          v(q, "catch", K["catch"], { unsafe: !0 }));
      try {
        delete q.constructor;
      } catch (gt) {}
      b && b(q, K);
    }
    a({ global: !0, wrap: !0, forced: ut }, { Promise: Y }),
      h(Y, U, !1, !0),
      y(U),
      (i = s(U)),
      a(
      ...
      a(
        ...
        {
          resolve: function (t) {
            return _(u && this === i ? Y : this, t);
          },
        }
      ),
      a(
        { target: U, stat: !0, forced: ft },
        {
          all: function (t) {
            var e = this,
              n = $(e),
